...
class Keyboard extends Component {
    ...
    /*** Add by Muchang ***/
    _isIdCardPad() {
        return this.props.keyboardType === 'idCard-pad';
    }
    ...
    _renderDotKey() {
        if (this.props.disableDot !== true) {
            ...
            if (this._isIdCardPad()) {
                console.log("CardPAd");
                dotText = 'x';
                dotNode = <Text style={[keyStyle.mainText, keyStyle.cardX]}>x</Text>
            }
            return (
                <TouchableHighlight
...
Keyboard.propTypes = {
    // 是否显示小数点符号
    keyboardType: PropTypes.oneOf(['number-pad', 'decimal-pad', 'idCard-pad']),
    // 点击键盘按键
